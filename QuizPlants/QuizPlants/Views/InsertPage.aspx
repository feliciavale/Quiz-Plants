<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertPage.aspx.cs" Inherits="QuizPlants.Views.InsertPage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div>
                <asp:Button ID="InsertBtn" runat="server" Text="Insert Plant" OnClick="InsertBtn_Click" />
            </div>
